  ...
  <body class="text-zinc-800 antialiased overflow-x-hidden w-full">
    <div class="bg-cover bg-center" style="background-image:url(images/gradient.jpg);">
      ...
      <div id="introduction" class="py-16 lg:py-20">
        <div class="container mx-auto">
          <h2 class="text-center mx-auto max-w-(--breakpoint-lg) text-3xl lg:text-6xl tracking-tight font-extrabold mt-4 mb-2 lg:leading-tight!">
            Rapidly build your WordPress theme with Tailwind CSS.
          </h2>

          <p class="text-center mx-auto max-w-(--breakpoint-md) text-zinc-700 text-xl lg:leading-relaxed! mb-10">
      ...
      <div class="w-full h-[100px] bg-linear-to-b from-transparent to-white"></div>
    </div>
        ...
        <div class="lg:w-1/2 px-8 lg:px-16">
          ...
          <ul>
            ...
            <li class="relative flex mb-8">
              <div class="shrink-0 rounded-full bg-zinc-50 text-zinc-500 flex items-center justify-center mr-4 h-12 w-12 text-lg lg:text-3xl lg:w-16 lg:h-16">2</div>
              <div class="max-w-[80%]">Now simply run
                <code class="bg-zinc-800 text-white px-8 py-4 rounded-sm block mt-4">tailpress new example-theme</code>
            ...
            <li class="shrink-0 relative flex mb-8">
              <div class="shrink-0 rounded-full bg-zinc-50 text-zinc-500 flex items-center justify-center mr-4 h-12 w-12 text-lg lg:text-3xl lg:w-16 lg:h-16">3</div>
              <div class="max-w-[80%]">Now go to the theme directory and watch for changes <code class="bg-zinc-800 text-white px-8 py-4 rounded-sm block mt-4">npm run watch</code></div>
            </li>
          </ul>
        </div>
        <div class="lg:w-1/2">
          <div class="relative py-3 sm:max-w-xl sm:mx-auto">
            <div class="absolute inset-0 bg-linear-to-r from-primary to-blue-500 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
                <iframe class="aspect-video w-full relative sm:rounded-3xl shadow-lg" src="https://www.youtube.com/embed/Yzdvy6XuTEk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
            <div class="text-zinc-500 text-center mt-12 px-8">In this video you'll get to see how you can use the installer.</div>
          </div>
      </div>
    </div>

    <div class="mx-auto container flex flex-wrap gap-8 justify-center">
      <div class="bg-zinc-50 px-4 py-3 rounded-full flex items-center">
    ...
    <footer class="bg-zinc-50 text-zinc-600">
        <div class="container py-16 mx-auto">
          <div class="text-center pb-12">
            <span class="text-red-500">♥</span> Huge thank you to <a href="https://wordpress.org/?ref=tailpress.io" class="text-zinc-900">WordPress</a>, <a href="https://tailwindcss.com/?ref=tailpress.io" class="text-zinc-900">Tailwind CSS</a> and <a href="https://laravel-mix.com/?ref=tailpress.io" class="text-zinc-900">Laravel Mix</a> for making this possible!
          </div>

          <div class="text-center border-t pt-12">
            The TailPress boilerplate theme is created by <a href="https://vanrossum.dev/" class="text-zinc-900">Jeffrey van Rossum</a>.
          </div>
        </div>
    </footer>
  </body>
